...
func (s *mmidService) GetServiceHistory(authorization request.HeaderRequest, params request.ServiceHistoryRequest) (*response.ServiceHistoryResponse, error) {
	...
	result, err := s.mmidRepo.GetServiceHistory(request.HeaderRequest{
